...
function setWallpaperEngine() {
	local STEAM_GAME_INSTALL_DIR=/mnt/games/SteamLibrary/steamapps/
	local WALLPAPER_ENGINE_INSTALL=$STEAM_GAME_INSTALL_DIR/common/wallpaper_engine
	local WALLPAPER_ENGINE_WORKSHOP_INSTALL=$STEAM_GAME_INSTALL_DIR/workshop/content/431960
